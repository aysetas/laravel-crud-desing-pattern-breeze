        ...
        <div class="col-md-8">
            <div class="card card-custom">
                ...
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    ...
                    <div class="trashed">
                        <a href="{{route('product.trashed')}}" class="btn btn-bg-warning btn-sm text-center"
                           style="padding-top: 10px"><i class="la la-trash"></i>Silinen Ürünler</a>
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <table class="table table-separate table-head-custom table-checkable dataTable no-footer"
                        ...
                        <tr role="row">
                            ...
                            <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1"
                                aria-label="Country: activate to sort column ascending">Kategoriler
                            </th>
                                    ...
                                    <form method="post" action="{{ route('product.update',$product->id) }}"
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group">
                                                    <label for="kt_select2_8"><strong>Kategori:</strong></label>
                                                    <select class="form-control select2 form-control-solid" id="kt_select2_8"
                                                            multiple="" name="categories[]" data-select2-id="kt_select2_8" tabindex="-1"
                                                            aria-hidden="true" >
                                                        <option label="Label" data-select2-id="377"></option>
                                                        <optgroup label="Kategoriler" data-select2-id="378">
                    ...
                    <div class="row justify-content-md-center">
                        <div class="col-md-10">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label><strong>Ürün Açıklaması:</strong></label>
                                    <input class="form-control form-control-solid" name="desc" type="text">
                                </div>
                                <div class="form-group">
                                    <label><strong>Ürün Fiyatı:</strong></label>
                                    <input class="form-control form-control-solid" name="price" type="text">
                                </div>
                                <div class="form-group">
                                    <label for="kt_select2_11"><strong>Kategori:</strong></label>
                                    <select class="form-control select2 form-control-solid" id="kt_select2_11"
                                            multiple="" name="categories[]" data-select2-id="kt_select2_11" tabindex="-1"
                                            aria-hidden="true" >
                                        <option label="Label" data-select2-id="377"></option>
                                        <optgroup label="Kategoriler" data-select2-id="378">
                                            @foreach($categories as $id=>$category)
...
@endsection
@section('footer')
    <script src="{{asset('Back/assets/js/pages/crud/forms/widgets/select2.js?v=7.2.2')}}"></script>
    <script>
